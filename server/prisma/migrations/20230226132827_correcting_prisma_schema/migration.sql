...
INSERT INTO "new_registers" ("category_id", "date", "description", "id", "method_id", "recurrence_id", "title", "type_id", "value") SELECT "category_id", "date", "description", "id", "method_id", "recurrence_id", "title", "type_id", "value" FROM "registers";
